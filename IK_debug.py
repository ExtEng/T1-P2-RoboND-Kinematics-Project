...
def test_code(test_case):
    ...
    DH_Table = {alpha0:        0, a0:     0, d1: d0_1, q1:        q1,
		alpha1: alpha1_2, a1:  a1_2, d2:    0, q2: -pi/2.+q2,
		alpha2:        0, a2:  a2_3, d3:    0, q3:        q3,
		alpha3: alpha3_4, a3:  a3_4, d4: d3_4, q4:        q4,
		alpha4: alpha4_5, a4:     0, d5:    0, q5:        q5,
		alpha5: alpha5_6, a5:     0, d6:    0, q6:        q6,
		alpha6:        0, a6:     0, d7: d6_7, q7:         0}
    
    
    #Define Mod DH Transformation Matrix
    ...
    #Create inidividual transformation matrices
